...
public class TemplateNumRunsAndNumInstances {
    ...
    public static Semaphore barb;
    public static Semaphore cust;
    ...
    public static void init(int numBarbers) {
        barb=new Semaphore(1);
        cust=new Semaphore(5);
    }
    ...
    static class Barber extends TemplateThread {
        ...
        public void execute() throws InterruptedException {
            ...
            state.barberWakeUp();
            if (state.arrivedCustomers==5) {
                barb.release();
            }
            
            // koga klientot ke pristigne, go vika klientot da vleze
            if (state.arrivedCustomers>0) {
